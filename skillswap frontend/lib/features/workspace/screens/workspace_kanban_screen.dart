  ...
  Widget _buildTaskCard(String title, String tag, bool isDoing) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: isDoing ? Border.all(color: AppColors.primaryTan, width: 2) : null,
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(tag, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppColors.primaryTan)),
          ),
          const SizedBox(height: 12),
          Text(title, style: const TextStyle(fontWeight: FontWeight.bold, color: AppColors.darkBrown, fontSize: 14)),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Text('$count', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: AppColors.darkBrown)),
              ),
            ],
          ),
          const SizedBox(height: 16),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildNavItem(Icons.assignment_rounded, true),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Project Workspace', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.darkBrown)),
                              Text('Batik Nusantara', style: TextStyle(fontSize: 12, color: Colors.grey)),
                            ],
                          ),
                        ],
                      ),
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: const Icon(Icons.chat_rounded, color: Color(0xFF7B1FA2)),
                        ),
                      )
                    ],
                  ),
                    ...
                    child: Row(
                      ...
                      children: [
                        _buildColumn('To Do', 3, [
                          _buildTaskCard('Design Header Section', 'UI/UX', false),
                          _buildTaskCard('Create Product Cards', 'UI/UX', false),
                          _buildTaskCard('Setup React Project', 'Development', false),
                        ]),
                        _buildColumn('In Progress', 1, [
                          _buildTaskCard('Wireframe initial concepts', 'Planning', true),
                        ]),
                        _buildColumn('Done', 0, []),
                      ],
                    ),
